...
import { cleanPrice, cleanPrice2, getCityNameFromTwoColumn, getCityNamesFromOneColumn, getHotelNameAndCityNameFromOneColumn, getMinMaxNumberOfPeople } from './utilities';
